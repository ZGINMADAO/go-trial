...
type  Product struct {
	...
	TypeId    int       `xorm:"type_id INT"form:"typeId"`
	Title     string    `xorm:"title CHAR(50) notnull"form:"title"`
	Price     int64     `xorm:"price BIGSERIAL"form:"price"`
	Stock     int       `xorm:"stock INT"form:"stock"`
